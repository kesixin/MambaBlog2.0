...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_cropperjs__ = __webpack_require__(326);
//
//
//
//
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            this.$http.put('users/' + this.$route.params.id, this.form).then(function (response) {
                ...
                if (_this3.$route.params.id == _this3.$store.state.user.userinfo.id) {
                    _this3.$store.commit('SET_USERINFO', response.data);
                }
